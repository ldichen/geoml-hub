                    ...
                    <ul class="space-y-2">
                        {#each sidebarItems as item}
                            <li>
                                <a
                                    href={item.path}
                                    class="flex items-center px-4 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-200 {$page.url.pathname === item.path ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-500' : ''}"
                                >
                                    <span class="mr-3">
