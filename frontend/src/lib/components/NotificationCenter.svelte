...
{#if isOpen}
	...
	<!-- 通知面板 -->
	<div
		class="fixed top-16 right-4 w-96 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 z-50 max-h-[80vh] flex flex-col"
	>
		<!-- 头部 -->
		<div
			...
			{:else if notifications.length > 0}
				<div class="divide-y divide-gray-100 dark:divide-gray-700">
					{#each notifications as notification}
						...
						<div
							class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer relative {!notification.is_read
