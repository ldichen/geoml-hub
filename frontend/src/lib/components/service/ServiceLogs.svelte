...
<div class="space-y-4">
	...
	<div class="flex items-center space-x-4">
		...
		<div class="relative">
			...
			{#if showFilterMenu}
				<div
					class="absolute right-0 top-full mt-1 w-64 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10"
				>
	...
	<div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
		...
		{:else if logs.length === 0}
			<div class="text-center py-12">
				...
				<h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">没有找到日志记录</h3>
				<p class="text-gray-500 dark:text-gray-400">
					{levelFilter || eventTypeFilter || searchQuery
						? '尝试调整筛选条件'
						: '此服务还没有生成任何日志'}
				</p>
			</div>
						...
						<div class="flex items-start space-x-3">
							...
							<div class="flex-1 min-w-0">
								...
								<div class="flex items-center space-x-3 mb-1">
									<span
										class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium {getLogLevelBg(
											log.log_level
...
{#if showFilterMenu}
	<div class="fixed inset-0 z-0" on:click={() => (showFilterMenu = false)} />
{/if}
