	...
	{:else}
		...
		>
			<p class="text-center text-gray-600 dark:text-gray-400">
				<a href={PATHS.LOGIN} class="text-primary-600 dark:text-primary-400 hover:underline">
					{$_('auth.login')}
				</a>
						...
						<div class="flex-1 min-w-0">
							...
							<div class="flex items-center space-x-2 mb-2">
								...
								{#if comment.author.is_verified}
									<span
										class="text-xs bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200 px-1.5 py-0.5 rounded"
									>
										{$_('user.verified')}
									</span>
								{/if}
