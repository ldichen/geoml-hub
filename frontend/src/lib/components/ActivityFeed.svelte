	...
	{:else if activities.length > 0}
		<div class="space-y-4">
			{#each activities as activity}
				...
				<div
					class="flex items-start space-x-3 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow"
				>
					<!-- 活动图标 -->
