...
class DockerService:
    ...
    async def create_container(self, config: ContainerCreateRequest) -> ContainerOperationResponse:
        """创建容器"""
        self._ensure_client()
        ...
        try:
            ...
            create_kwargs = {
                ...
                'labels': {
                    **config.labels,
                    ...
                    'mmanager.created_at': datetime.utcnow().isoformat()
                },
            ...
            container = await loop.run_in_executor(
                None, 
                lambda: self.client.containers.create(**create_kwargs)
            )
    ...
    async def stop_container(self, container_id: str, timeout: int = 10) -> ContainerOperationResponse:
        """停止容器"""
        self._ensure_client()
    ...
    async def remove_container(self, container_id: str, force: bool = False) -> ContainerOperationResponse:
        """删除容器"""
        self._ensure_client()
